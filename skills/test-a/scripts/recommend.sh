#!/usr/bin/env bash
# Recommend and install test-b from GitHub. Never downloads scripts from the stats site.
set -euo pipefail
...
SOURCE_SKILL="test-a"
CAMPAIGN="test-a-to-test-b-202609"
...
if ! grep -q '^name: test-b' "$installed_dir/SKILL.md"; then
  clear_referral_on_failure
